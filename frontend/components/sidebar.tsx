...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-[220px] border-r border-border bg-white lg:flex lg:flex-col 2xl:w-[232px]">
      <div className="flex h-[60px] items-center gap-3 px-4">
        <div className="grid h-7 w-7 place-items-center rounded-lg bg-accent text-white shadow-panel">
          <Hexagon className="h-4 w-4 fill-current" aria-hidden="true" />
        </div>
        <div className="min-w-0">
          <p className="truncate text-[15px] font-bold text-ink">Multimodal Agent</p>
        </div>
      </div>
      <nav className="flex-1 space-y-4 px-3 py-3" aria-label="Primary navigation">
      ...
      <div className="p-2.5">
        <button
          className="flex w-full items-center gap-2.5 rounded-lg border border-border bg-white p-2.5 text-left shadow-panel"
          type="button"
        >
          <div className="relative grid h-8 w-8 place-items-center rounded-md bg-info-soft text-info">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[13px] font-semibold text-ink">Enterprise Workspace</p>
          </div>
